/*
 * $Id: AbstractConnector.java 21284 2011-02-15 18:47:04Z dfeist $
 * --------------------------------------------------------------------------------------
...
public abstract class AbstractConnector implements Connector, WorkListener
{
    ...
    public AbstractConnector(MuleContext context)
    {
        ...
        {
            logger.debug("MULE-5575 FIX for AbstractConnector: Constructor called");
        }
...
//                .getClassLoader());
        if (logger.isDebugEnabled())
        {
            logger.debug("MULE-5575 FIX for AbstractConnector: Classloader fix applied");
        }
