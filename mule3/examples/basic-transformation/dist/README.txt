...
+-------------------------------------+
This example demonstrates how perform a basic XSLT transform in Mule 3, using Smooks.
...
*            - - + APPLICATION + - -            * - - + STATUS + - - *
**********************************************************************
* smooks-4-mule-3-examples-basic-transformation * DEPLOYED           *
* default                                       * DEPLOYED           *
**********************************************************************
...
${MULE_HOME}/apps/smooks-4-mule-3-examples-basic-transformation-1.3-anchor.txt
